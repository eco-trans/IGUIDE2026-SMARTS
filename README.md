...
SMARTS is a lightweight simulation framework for public transit research.
It models vehicles, passengers, stops, routes, and a network topology, enabling experiments with control policies, scheduling strategies, and reinforcement learning agents.
